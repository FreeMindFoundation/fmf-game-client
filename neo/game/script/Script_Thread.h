...
extern const idEventDef EV_Thread_AcosineDeg;
extern const idEventDef EV_Thread_Atan2Deg;
...
private:
	...
	void						Event_GetAcosineDeg( float angle );
	void						Event_GetAtan2Deg( float a, float b );
	...
	void						Event_Vec3Angle( idVec3 &a, idVec3 &b ); 
